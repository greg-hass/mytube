...
Task:
You are the executor for implementation plan 005 at plans/005-trust-proxy.md in the repo root.

Read the full plan file FIRST, then follow it step by step. Run every verification command and confirm the expected result before moving on. Touch only the files listed as in scope (server/app-factory.js, server/security-middleware.test.js). If any STOP condition occurs, stop immediately and report.
